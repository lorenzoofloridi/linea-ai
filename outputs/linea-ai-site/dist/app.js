...
const companyToken=new URLSearchParams(location.search).get('azienda')||'demo';let greetingText='Ciao! Sono l’assistente virtuale di Azienda Demo Linea AI. Come posso aiutarti oggi?';
