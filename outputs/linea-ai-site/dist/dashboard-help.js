...
'Installazioni':'Elenca i siti su cui è installata la chat della tua azienda.',
...
'Conferme email':'Invia una conferma al cliente quando ha indicato un’email.',
...
'Calendario di prova':'Disponibilità di prova per le prenotazioni. Non aggiorna calendari esterni.',
...
function scan(){document.querySelectorAll('.dashboard h2,.dashboard h3,.dashboard legend,.dashboard label,.dash-dialog h3,.dash-dialog label').forEach(t=>{if(!t.closest('#prova-ai,#widget-card'))add(t)})}
