...
function scan(){document.querySelectorAll('.dashboard h2,.dashboard h3,.dashboard legend,.dashboard label,.dash-dialog h3,.dash-dialog label').forEach(t=>{if(!t.closest('#prova-ai'))add(t)})}
